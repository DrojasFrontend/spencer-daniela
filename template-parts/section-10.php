  ...
  "hotels" => [
    ...
    "places" => [
        ...
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-3.webp',
        ],
        [
            "name" => "Movich Hotel",
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-4.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-5.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-6.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-7.webp',
        ],
        [
            "name" => "Casa Pestagua",
            "address" => "Cra. 3 # 33 - 63",
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-8.webp',
        ],
        [
            "name" => "Casa La Merced",
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-9.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-10.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-11.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-12.webp',
        ],
        [
        ...
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/hoteles-15.webp',
        ],
    ],
  ],
  "restaurants" => [
    ...
    "places" => [
        ...
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/restaurantes-8.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/restaurantes-9.webp',
        ],
        [
            "name" => "Agua de León",
            ...
            "image" => IMG_BASE . 'places-cartagena/restaurantes-10.webp',
        ],
        [
            "name" => "Mar y Zielo",
            "address" => "Cra. 5 # 34 - 63",
            ...
            "image" => IMG_BASE . 'places-cartagena/restaurantes-11.webp',
        ],
        [
            "name" => "Celele",
            ...
            "image" => IMG_BASE . 'places-cartagena/restaurantes-12.webp',
        ],
        [
            "name" => "La Vitrola",
            "address" => "Cra. 2 # 33 - 66",
            ...
            "image" => IMG_BASE . 'places-cartagena/restaurantes-13.webp',
        ],
        [
            "name" => "Mardeleva",
            ...
            "image" => IMG_BASE . 'places-cartagena/restaurantes-14.webp',
        ],
    ]
  ],
  "bars_pubs" => [
    ...
    "places" => [
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/bares-1.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/bares-2.webp',
        ],
        [
            "name" => "Alquímico",
            ...
            "image" => IMG_BASE . 'places-cartagena/bares-3.webp',
        ],
        [
            "name" => "La Jugada",
            "address" => "Cra. 6 # 34 - 25",
            ...
            "image" => IMG_BASE . 'places-cartagena/bares-4.webp',
        ],
        [
            "name" => "Buena Vida",
            ...
            "image" => IMG_BASE . 'places-cartagena/bares-5.webp',
        ],
        [
            "name" => "El Coro",
            "address" => "Cra. 8 # 39 - 36",
            ...
            "phone" => "57 (605) 6504700",
            "link" => "https://www.sofitellegendsantaclara.com/",
            "image" => IMG_BASE . 'places-cartagena/bares-6.webp',
        ],
    ]
  ],
  "brunch_desserts" => [
    ...
    "places" => [
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/postres-1.webp',
        ],
        [
            "name" => "Pascal",
            ...
            "image" => IMG_BASE . 'places-cartagena/postres-2.webp',
        ],
        [
            "name" => "Época Espresso",
            "address" => "Cra. 5 # 34 - 52",
            ...
            "image" => IMG_BASE . 'places-cartagena/postres-3.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/postres-4.webp',
        ],
        [
            "name" => "La Paletteria",
            ...
            "image" => IMG_BASE . 'places-cartagena/postres-5.webp',
        ],
        [
            "name" => "Café Quindío",
            ...
            "image" => IMG_BASE . 'places-cartagena/postres-6.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/postres-7.webp',
        ],
        [
            "name" => "El Café Ábaco",
            ...
            "image" => IMG_BASE . 'places-cartagena/postres-8.webp',
        ],
    ]
  ],
  "boutiques" => [
    ...
    "places" => [
        ...
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/boutiques-4.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/boutiques-5.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/boutiques-6.webp',
        ],
        [
            "name" => "Goretty Medina",
            ...
            "image" => IMG_BASE . 'places-cartagena/boutiques-7.webp',
        ],
        [
            "name" => "Ketty Tinoco",
            ...
            "image" => IMG_BASE . 'places-cartagena/boutiques-8.webp',
        ],
        [
            "name" => "Azulu",
            "address" => "Cra. 3 # 31 - 11",
            ...
            "link" => "https://azulu.co",
            "image" => IMG_BASE . 'places-cartagena/boutiques-9.webp',
        ],
        [
            ...
            "image" => IMG_BASE . 'places-cartagena/boutiques-10.webp',
        ],
        [
            "name" => "D'Clase",
            ...
            "image" => IMG_BASE . 'places-cartagena/boutiques-11.webp',
        ],
    ]
  ],
  "salones_de_belleza" => [
...
<section class="sectionCartagena">
    <img class="sectionCartagena__img" src="<?php echo IMG_BASE . 'img-9.webp'?>" alt="">
    <div class="">
        ...
        <div class="sectionCartagena__wrapper">
            <div class="sectionCartagena__title">
                <p class="font--blancha heading--72 color--836923">
                    Enjoy
                    <img class="" src="<?php echo IMG_BASE . 'airplane.png'?>" alt="">
                </p>
                <h2 class="font--nesans heading--96 color--836923">CARTAGENA</h2>
                <p class="heading--40 color--836923">DISFRUTA CARTAGENA</p>
            </div>
        </div>
        ...
        <div class="sectionCartagena__slick" id="<?php echo $category['id']; ?>">
            ...
            <div class="sectionCartagena__wrapper">
                <div class="sectionCartagena__icon">
                    ...
                    <div>
                        <h2 class="heading--48 color--836923 uppercase"><?php echo $category['title']; ?></h2>
                        <p class="heading--32 color--836923 uppercase"><?php echo $category['title_es']; ?></p>
                    </div>
                </div>
            <div class="slick0">
                <?php foreach ($category['places'] as $place) { ?>
                    <div class="sectionCartagena__card">
                        <div class="sectionCartagena__padding">
                            ...
                            <h2 class="heading--24 color--836923 uppercase">
                                <?php echo $place['name']; ?>
                            </h2>
        
                            <?php if ($place['address']) : ?>
                            <p class="heading--20 color--4F4F4F"><?php echo $place['address']; ?></p>
                            <?php endif?>
        
                            <?php if ($place['city']) : ?>
                            <p class="heading--20 color--4F4F4F"><?php echo $place['city']; ?></p>
                            <?php endif?>
        
                            <div class="space space--20"></div>
        
                            <?php if ($place['phone']) : ?>
                            <p class="heading--28 color--4F4F4F" style="-webkit-text-stroke-width: 0.5px;letter-spacing: 1.4px;"><?php echo $place['phone']; ?></p>
                            <?php endif?>
